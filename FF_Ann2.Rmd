...
```{r}
#FF
Livneh_Gen_Mer_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c( 1,4,7,10)] %>%
...
Livneh_Gen_Stn_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,7,10,13,16,19,22,25,28,31,34)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_Stn_FF<- Livneh_Gen_Stn_FF %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_Stn_FF[c(2:12)]),
         Basin = "Stanislaus River", Scenario = "Functional Flows")
Livneh_Gen_Stn_FF

Livneh_Gen_USJ_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,4,7,10,13,16,19,22,25,28,31,34,37,40,43,46,49)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_USJ_FF<- Livneh_Gen_USJ_FF  %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_USJ_FF[c(2:17)]),
         Basin = "Upper San Joaquin River", Scenario = "Functional Flows")
Livneh_Gen_USJ_FF

Livneh_Gen_Tuo_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,7,10,13)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_Tuo_FF<- Livneh_Gen_Tuo_FF  %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_Tuo_FF[c(2:5)]),
...
```{r}
Livneh_Gen_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,5,8)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,5,8,11,14,17,20,23,26,29,32)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Gen_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,5,8,11,14,17,20,23,26,29,32,35,38,41,44,47)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Gen_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,5,8,11)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh_Gen_SWRCBMer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3,6,9)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Gen_SWRCBStn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3,6,9,12,15,18,21,24,27,30,33)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_SWRCBStn<- Livneh_Gen_SWRCBStn %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_SWRCBStn[c(2:12)]),
         Basin = "Stanislaus River", Scenario = "40% Full Natural Flow")
Livneh_Gen_SWRCBStn

Livneh_Gen_SWRCBUSJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3,6,9,12,15,18,21,24,27,30,33,36,39,42,45,48)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_SWRCBUSJ<- Livneh_Gen_SWRCBUSJ  %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_SWRCBUSJ[c(2:17)]),
         Basin = "Upper San Joaquin River", Scenario = "40% Full Natural Flow")
Livneh_Gen_SWRCBUSJ

Livneh_Gen_SWRCBTuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3,6,9,12)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))

Livneh_Gen_SWRCBTuo<- Livneh_Gen_SWRCBTuo  %>%
  mutate(`Livneh (Historical)` = rowSums(Livneh_Gen_SWRCBTuo[c(2:5)]),
...
Gen_Mer <- rbind(Livneh_Gen_Mer[-c(2:4)], Livneh_Gen_Mer_FF[-c(2:4)], 
                 Livneh_Gen_Tuo[-c(2:5)], Livneh_Gen_Tuo_FF[-c(2:5)], 
                 Livneh_Gen_Stn[-c(2:12)], Livneh_Gen_Stn_FF[-c(2:12)],
                 Livneh_Gen_USJ[-c(2:17)], Livneh_Gen_USJ_FF[-c(2:17)],
                 Livneh_Gen_SWRCBMer[-c(2:4)], Livneh_Gen_SWRCBTuo[-c(2:5)],
                 Livneh_Gen_SWRCBStn[-c(2:12)], Livneh_Gen_SWRCBUSJ[-c(2:17)])
...
png("Allbasins_RCP85_2009prices_FlowScenarios_log2_egu.png", units ="in", width=6, height=10, res = 300)
...
ggplot(Gen_Mer2)+#%>% filter(Basin == "Merced River")) + 
  theme_bw(base_size=12, base_family='Times New Roman') + #change font to Times New Roman, 12pt, Bold
  geom_boxplot(aes( x = Month, y = MonthlyTotal/1000, fill = Scenario), outlier.alpha = 0.3) + #plot monthly observed data in greenish blue
  #geom_line(aes(x = node, y = value)) +
  scale_y_continuous(limits = c(0, NA),
...
ggplot(Gen_Mer3) + 
  ...
  theme(legend.position = "none",
        ...
        strip.background = element_blank(),
        panel.spacing.y = unit(0, "lines"))+
  png("Mer_annual_generation_RCP85_NoIFRs_2009prices_Report.png", units ="in", width=11.5, height=4.5, res = 300)
...
write.csv(All_Montlhy_Stats_Gen, "All_Monthly_Stats_Generation_Baseline_RCP85_Report_March.csv")

All_Annual_Stats_Gen <- aggregate(AnnualTotal ~ Scenario+Basin, Gen_Mer3, summary)
write.csv(All_Annual_Stats_Gen, "All_Annual_Stats_Generation_Baseline_RCP85_Report_March.csv")
```
...
```{r}
#FF
Livneh_Outflow_Mer_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c( 1,11)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_Stn_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_USJ_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_Tuo_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh_Outflow_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,10)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,6)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh_Outflow_SWRCBMer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/SWRCB40 - 2021-03-17/merced/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_SWRCBStn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_SWRCBUSJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Outflow_SWRCBTuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/SWRCB40 - 2021-03-17/tuolumne/historical/Livneh/Output_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,5)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
png("IFR_ShafferBidge_Merced_Baseline_2009prices_FlowScenarios_Outflow_awra.png", units ="in", width=7, height=6, res = 300)
```
...
#name of x axis
  theme(legend.position = "bottom",
        ...
        panel.spacing.y = unit(0, "lines"))+
  facet_wrap(~Year, ncol=1, scales = "free", strip.position = "left") +
png("IFRShafferBridge_Baseline_FlowScenarios_awra.png", units ="in", width=7, height=6, res = 300)
...
```{r}
ff3 <- rbind(Livneh_Outflow_SWRCBMer,Livneh_Outflow_Mer, Livneh_Outflow_Mer_FF) %>%
mutate(Year = water_year(node, origin = "usgs"),
Scenario = as.factor(Scenario))

ggplot(ff3)+#%>% filter(Basin == "Merced River")) + 
  theme_bw(base_size=12, base_family='Times New Roman') + #change font to Times New Roman, 12pt, Bold
  geom_boxplot(aes( x = Month, y = MonthlyTotal/1000, fill = Scenario), outlier.alpha = 0.3) + #plot monthly observed data in greenish blue
  #geom_line(aes(x = node, y = value)) +
  scale_y_continuous(limits = c(0, NA),
  ...
  theme(legend.position = "bottom",
        ...
        panel.spacing.y = unit(0, "lines"))+
  facet_wrap(~Basin, ncol=1, scales = "free_y", strip.position = "left") +
  png("Allbasins_RCP85_2009prices_FlowScenarios_log2_Rawra.png", units ="in", width=6, height=10, res = 300)
...
#df[3:ncol(df)] <- df[3:ncol(df)]-df[,2]
write.csv(Outflow_Mer3, "Total_Outflow_per_WY_Flowscenarios_Report_March.csv")
```
...
write.csv(All_Montlhy_Stats_Gen, "All_Monthly_Stats_Outflow_Generation_Baseline_Report_March.csv")

All_Annual_Stats_Gen <- aggregate(AnnualTotal ~ Scenario+Basin, Outflow_Mer3, summary)
write.csv(All_Annual_Stats_Gen, "All_Annual_Stats_Outflow_Baseline_Report_March.csv")
```
...
ggplot(Outflow_Mer2) + 
  ...
  png("Allbasins_RCP85_2009prices_FlowScenarios_Outflow_Report_March.png", units ="in", width=6, height=9, res = 300)
...
```{r}
#FF
Livneh_Stor_Mer_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c( 1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_Stn_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,23)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_USJ_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_Tuo_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,11)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,6)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,22)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,6)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,10)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh_Stor_SWRCBMer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/SWRCB40 - 2021-03-17/merced/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,5)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_SWRCBStn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,13)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_SWRCBUSJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh_Stor_SWRCBTuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/SWRCB40 - 2021-03-17/tuolumne/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,7)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
write.csv(All_Spill_annual, "Annual_Spill_per_Basin_per_scenario_Report_March.csv")
write.csv(All_Spill, "Monthly_Spill_per_Basin_per_scenario_Report_March.csv")
```
...
All_Storage_annual <- All_Spill1 %>%
  ...
  summarise(AnnualCount = sum(Count),
            Annualmean = mean(Count))# %>%
#Outflow_Mer1 <- melt(Outflow_Mer, id = c("node", "Basin", "Scenario")) 
write.csv(All_Storage_annual, "Annual_Storag_Below30%Oct1_per_Basin_per_scenario_Report_March.csv")
write.csv(All_Spill, "Monthly_Storage_Below30%Oct1_per_Basin_per_scenario_Report_March.csv")
```
...
```{r}
#FF
Livneh__SpillMer_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c( 1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh__SpillStn_FF <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,35)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh__SpillMer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh__SpillStn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,34)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
```{r}
Livneh__SpillSWRCBMer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/merced/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,3)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh__SpillSWRCBStn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/stanislaus/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,19)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh__SpillSWRCBUSJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/upper_san_joaquin/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,17)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
Livneh__SpillSWRCBTuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/pywr_models/results/All IFR scenarios - whole basin - 2022-12-05/tuolumne/historical/Livneh/InstreamFlowRequirement_Flow_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:2), c(1,9)] %>%
  filter(between(node, as.Date("1950-10-01"), as.Date("2011-09-30")))
...
All_Spill_annual <- All_Spill %>%
  ...
  summarise(AnnualCount = sum(Count),
            Annualmean = mean(Count))# %>%
#Outflow_Mer1 <- melt(Outflow_Mer, id = c("node", "Basin", "Scenario")) 
write.csv(All_Spill_annual, "Annual_Spill_per_Basin_per_scenario_Report.csv")
write.csv(All_Spill1, "Monthly_Spill_per_Basin_per_scenario_Report.csv")
```