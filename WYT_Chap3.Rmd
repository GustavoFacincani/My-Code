...
```{r}
# put your df in two columns, and preserve the ordering in many levels (columns) with paste0
links <- data.frame(source = c(paste0(wyt_info$`Different WYTs`,'_1'),paste0(wyt_info$`Different flow prescriptions`,'_2'),paste0(wyt_info$`Number of seasonal variations`,'_3')),
                  target   = c(paste0(wyt_info$`Different flow prescriptions`,'_2'),paste0(wyt_info$`Number of seasonal variations`,'_3'),paste0(wyt_info$`Temperature management`,'_4')))
