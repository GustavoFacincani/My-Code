...
```{r}
Livneh_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12)]

CanES_Gen_Mer4.5<- CanES_Gen_Mer4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Mer4.5[c(2:4)]))
CanES_Gen_Mer4.5

CNRM_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12)]
...
HadGEM_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12)]
...
MIROC_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12)] 
...
```{r}
Livneh_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16)]

CanES_Gen_Tuo4.5<- CanES_Gen_Tuo4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Tuo4.5[c(2:5)]))
CanES_Gen_Tuo4.5

CNRM_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16)]
...
HadGEM_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16)]
...
MIROC_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16)] 
...
Livneh_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]

CanES_Gen_Stn<- CanES_Gen_Stn %>%
  mutate(Total = rowSums(CanES_Gen_Stn[c(2:12)]))
CanES_Gen_Stn

CNRM_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]
...
HadGEM_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]
...
MIROC_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)] 
...
```{r}
Livneh_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]

CanES_Gen_Stn4.5<- CanES_Gen_Stn4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Stn4.5[c(2:12)]))
CanES_Gen_Stn4.5

CNRM_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]
...
HadGEM_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)]
...
MIROC_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44)] 
...
CanES_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64)]
...
HadGEM_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64)]
...
MIROC_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64)] 
...
#  scale_fill_manual(values = c("#5A5A5A", "#E69F00", "#F0E442", "#009E73", "#56B4E9")) +
  ...
  labs(color = Legend,
       linetype = FALSE,
       title = "Electricity Generation (2045 prices)",
    y = "Density", 
       x = "Centroid Time (Day)") + 
...
#  scale_fill_manual(values = c("#5A5A5A", "#E69F00", "#F0E442", "#009E73", "#56B4E9")) +
    ...
    scale_x_continuous(expand = c(0, NA),
                 #      limits = c(93,280), #From Jan 1 to Jul 15
                       ...
                       labels = c("Dec 1","Jan 1","Feb 1", "Mar 1",
                                  "Apr 1", "May 1", "Jun 1", "Jul 1", "Aug 1")) +
  labs(subtitle = "Electricity Generation (2045 prices)",
       title = element_blank(),
    y = "Density", 
       x = "Centroid Time (Day)") + 
 theme(plot.margin = margin(c(1,8,1,1, "cm")), #add a margin to not cut the graph
...
stat_smooth(aes(x = Year, y = DoY_50pct_TotalQ, method = "loess", 
    ...
    labs(title = Title,
       subtitle = "Electricity Generation (2045 prices)",
    x = element_blank(), 
       y = "Centroid Time (Days)") + #name of x axis
  theme(plot.margin = margin(c(12,10,1,1, "cm")),
    panel.spacing = unit(1.4, "lines"),
