...
CT <- function(x) {
  read_csv(x, col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10)] %>%
    filter(between(date, as.Date("2030-10-01"), as.Date("2060-09-30")))}
...
```{r}
Livneh_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11)]

CanES_Gen_Mer4.5<- CanES_Gen_Mer4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Mer4.5[c(2:4)]))
CanES_Gen_Mer4.5

CNRM_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11)]
...
HadGEM_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11)]
...
MIROC_Gen_Mer4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11)] 
...
```{r}
Livneh_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15)]

CanES_Gen_Tuo4.5<- CanES_Gen_Tuo4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Tuo4.5[c(2:5)]))
CanES_Gen_Tuo4.5

CNRM_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15)]
...
HadGEM_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15)]
...
MIROC_Gen_Tuo4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15)] 
...
Livneh_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]

CanES_Gen_Stn<- CanES_Gen_Stn %>%
  mutate(Total = rowSums(CanES_Gen_Stn[c(2:12)]))
CanES_Gen_Stn

CNRM_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]
...
HadGEM_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]
...
MIROC_Gen_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)] 
...
```{r}
Livneh_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]

CanES_Gen_Stn4.5<- CanES_Gen_Stn4.5 %>%
  mutate(Total = rowSums(CanES_Gen_Stn4.5[c(2:12)]))
CanES_Gen_Stn4.5

CNRM_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]
...
HadGEM_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)]
...
MIROC_Gen_Stn4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43)] 
...
Livneh_Gen_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/historical/Livneh/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)] %>%
  filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
...
CanES_Gen_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CanESM2_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]

CanES_Gen_USJ<- CanES_Gen_USJ %>%
  mutate(Total = rowSums(CanES_Gen_USJ[c(2:17)]))
CanES_Gen_USJ

CNRM_Gen_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CNRM-CM5_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]
...
HadGEM_Gen_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/HadGEM2-ES_rcp85/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]
...
CanES_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CanESM2_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]

CanES_Gen_USJ4.5<- CanES_Gen_USJ4.5 %>%
  mutate(Total = rowSums(CanES_Gen_USJ4.5[c(2:17)]))
CanES_Gen_USJ4.5

CNRM_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CNRM-CM5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]
...
HadGEM_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/HadGEM2-ES_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)]
...
MIROC_Gen_USJ4.5 <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/MIROC5_rcp45/Hydropower_Energy_MWh.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, 51, 55, 59, 63)] 
...
Density_plot_Gen(CT_Gen4.5, element_blank(), "RCP 4.5") +
  png("AllBasins_CT_Timing_Electricity_RCP45_Scalesfree_NoIFR.png", units ="in", width=5.5, height=6, res = 300)
```

```{r}
Density_plot_Gen(CT_Gen8.5, element_blank(), "RCP 8.5") +
  png("AllBasins_CT_Electricity_RCP85_Scalesfree_NoIFR.png", units ="in", width=5.5, height=6, res = 300)
```
...
Density_plot_Gen2(CT_Gen4.5, element_blank(), "RCP 4.5") +
  png("AllBasins_CT_Timing_Electricity_RCP45_Scalesfixed_NoIFR.png", units ="in", width=5.5, height=6, res = 300)
```

```{r}
Density_plot_Gen2(CT_Gen8.5, element_blank(), "RCP 8.5") +
  png("AllBasins_CT_Electricity_RCP85_Scalesfixed_NoIFR.png", units ="in", width=5.5, height=6, res = 300)
```
...
png("Mer_CT_generation2.png", units ="in", width=10, height=4, res = 300)
```


```{r}
CT_Generation(CT_TuoGen, "Tuolumne River", "Electricity Generation")+
png("Tuo_CT_generation2.png", units ="in", width=10, height=4, res = 300)
```
