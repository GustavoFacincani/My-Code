...
```{r}
Livneh_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/historical/Livneh/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,8)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `Livneh (Historical)` = as.numeric(`Lake McClure_2`)) %>%
    filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
Livneh_Stor_Mer

CanES_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,8)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `CanESM2` = as.numeric(`Lake McClure_2`))
CanES_Stor_Mer

CNRM_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,8)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `CNRM-CM5` = as.numeric(`Lake McClure_2`))
CNRM_Stor_Mer


HadGEM_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,8)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `HadGEM2-ES` = as.numeric(`Lake McClure_2`))
HadGEM_Stor_Mer


MIROC_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,8)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           MIROC5 = as.numeric(`Lake McClure_2`))
MIROC_Stor_Mer
...
CanES_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7,11, 15)]
CanES_Stor_Tuo
...
CNRM_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7,11, 15)]
CNRM_Stor_Tuo
...
HadGEM_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7,11, 15)]
HadGEM_Stor_Tuo
...
MIROC_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,3,7,11, 15)]
MIROC_Stor_Tuo
...
```{r}
Livneh_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40)] 
Livneh_Stor_Stn
...
CanES_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40)]
CanES_Stor_Stn
...
CNRM_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40)]
CNRM_Stor_Stn
...
HadGEM_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40)]
HadGEM_Stor_Stn
...
MIROC_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36, 40)]
MIROC_Stor_Stn
...
Stor_NewMelones <- rbind(Livneh_Stor_Stn[c(1,7,13)], CanES_Stor_Stn[c(1,7,13)],
    ...
    dplyr::rename(`New Melones Lake` = `New Melones Lake_2`)
Stor_NewMelones
...
```{r}
Livneh_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/historical/Livneh/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36)] 
Livneh_Stor_USJ
...
CanES_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36)]
CanES_Stor_USJ
...
CNRM_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36)]
CNRM_Stor_USJ
...
HadGEM_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36)]
HadGEM_Stor_USJ
...
MIROC_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,4,8, 12, 16, 20, 24, 28, 32, 36)]
MIROC_Stor_USJ
...
Stor_Millerton <- rbind(Livneh_Stor_USJ[c(1,4,12)], CanES_Stor_USJ[c(1,4,12)],
  ...
  dplyr::rename(`Millerton Lake` = `Millerton Lake_2`)
Stor_Millerton
