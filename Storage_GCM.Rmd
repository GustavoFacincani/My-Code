...
```{r}
Livneh_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/historical/Livneh/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,6)] %>%
...
CanES_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,6)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `CanESM2` = as.numeric(`Lake McClure`))
CanES_Stor_Mer

CNRM_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,6)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `CNRM-CM5` = as.numeric(`Lake McClure`))
CNRM_Stor_Mer


HadGEM_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,6)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
           `HadGEM2-ES` = as.numeric(`Lake McClure`))
HadGEM_Stor_Mer


MIROC_Stor_Mer <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/merced/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv")[-c(1:3), c(1,6)] %>%
 mutate(node = as.Date(node, format = "%Y-%m-%d"),
...
png("Mer_storage_MIROC5.png", units ="in", width=8, height=5, res = 300)
...
Livneh_Stor_Tuo <-Livneh_Stor_Tuo %>%
 mutate(`Livneh (Historical)` = rowSums(Livneh_Stor_Tuo[c(2,3,4,5)])) %>%
      filter(between(node, as.Date("1980-10-01"), as.Date("2010-09-30")))
Livneh_Stor_Tuo


CanES_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10, 14)]
CanES_Stor_Tuo

CanES_Stor_Tuo <- CanES_Stor_Tuo %>%
   mutate(CanESM2 = rowSums(CanES_Stor_Tuo[c(2,3,4,5)]))
CanES_Stor_Tuo
  

CNRM_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10, 14)]
CNRM_Stor_Tuo

CNRM_Stor_Tuo <- CNRM_Stor_Tuo %>%
   mutate(`CNRM-CM5` = rowSums(CNRM_Stor_Tuo[c(2,3,4,5)]))

CNRM_Stor_Tuo


HadGEM_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10, 14)]
HadGEM_Stor_Tuo

HadGEM_Stor_Tuo <- HadGEM_Stor_Tuo %>%
   mutate(`HadGEM2-ES` = rowSums(HadGEM_Stor_Tuo[c(2,3,4,5)]))
HadGEM_Stor_Tuo


MIROC_Stor_Tuo <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/tuolumne/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10, 14)]
MIROC_Stor_Tuo
MIROC_Stor_Tuo <- MIROC_Stor_Tuo %>%
   mutate(MIROC5 = rowSums(MIROC_Stor_Tuo[c(2,3,4,5)]))
...
Stor_Tuo <- cbind(CanES_Stor_Tuo[-c(2,3,4,5)], CNRM_Stor_Tuo[-c(2,3,4,5)], 
                HadGEM_Stor_Tuo[-c(2,3,4,5)], MIROC_Stor_Tuo[-c(2,3,4,5)])
Stor_Tuo
...
CanES_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34,38)]
CanES_Stor_Stn
...
CNRM_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34,38)]
CNRM_Stor_Stn
...
HadGEM_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34,38)]
HadGEM_Stor_Stn
...
MIROC_Stor_Stn <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/stanislaus/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1, 2,6,10,14,18,22,26,30,34,38)]
MIROC_Stor_Stn
...
CanES_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CanESM2_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34)]
CanES_Stor_USJ
...
CNRM_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/CNRM-CM5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34)]
CNRM_Stor_USJ
...
HadGEM_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/HadGEM2-ES_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1,2,6,10,14,18,22,26,30,34)]
HadGEM_Stor_USJ
...
MIROC_Stor_USJ <- read_csv("C:/Users/gusta/Box/VICE Lab/RESEARCH/PROJECTS/CERC-WET/Task7_San_Joaquin_Model/Pywr models/results/Binary IFRs x Prices/upper_san_joaquin/gcms/MIROC5_rcp45/Reservoir_Storage_mcm.csv", col_types = cols(node = col_date(), .default = col_double()))[-c(1:3), c(1, 2,6,10,14,18,22,26,30,34)]
MIROC_Stor_USJ
